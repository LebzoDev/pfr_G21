...
class Profil extends \App\Entity\Profil implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getLibelleProfil(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLibelleProfil', []);

        return parent::getLibelleProfil();
    }

    /**
     * {@inheritDoc}
     */
    public function setLibelleProfil(string $libelle_Profil): \App\Entity\Profil
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLibelleProfil', [$libelle_Profil]);

        return parent::setLibelleProfil($libelle_Profil);
    }
