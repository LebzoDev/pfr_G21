...
class getBriefControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\BriefController'] = $instance = new \App\Controller\BriefController(($container->privates['App\\Repository\\BriefRepository'] ?? $container->load('getBriefRepositoryService')), ($container->services['doctrine.orm.default_entity_manager'] ?? $container->getDoctrine_Orm_DefaultEntityManagerService()), ($container->privates['App\\Repository\\BriefMaPromoRepository'] ?? $container->load('getBriefMaPromoRepositoryService')));
