...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\DataFixtures\\Profil.php';
        include_once \dirname(__DIR__, 4).'\\src\\DataFixtures\\ProfilSortieFixtures.php';
        include_once \dirname(__DIR__, 4).'\\src\\DataFixtures\\Utilisateur.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ApprenantFixtures($b), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\CompetenceFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\Profil(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\ProfilSortieFixtures(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\Utilisateur($b), 'groups' => []]]);
